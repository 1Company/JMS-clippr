        ...
        <form onSubmit={handleSubmit} className="overflow-y-auto max-h-[calc(90vh-120px)]">
          <div className="p-5 space-y-4">
            ...
            {selectedService && formData.staffId && (
              <div className="bg-teal-50/60 rounded-xl p-3.5 border border-teal-100/50 text-sm">
                <div className="flex justify-between items-center">
                  <span className="font-medium">{selectedService.name}</span>
                  <span className="font-semibold text-teal-700 tabular-nums">€{selectedService.price.toFixed(2)}</span>
                </div>
